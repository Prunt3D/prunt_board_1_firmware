...
# Modified to work with this program in ways that could make it less reliable.
...
class Graphs:
    ...
    def _resolve(self, name):
        ...
        the cached result).
        """
        if name.startswith("ada__exceptions") or name == "__gnat_raise_exception":
            return 0
